                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                <ul class="nav side-menu">
                                    <li class="active">
                                        <router-link to="/main/stat"><i class="fa fa-home"></i>后台首页</router-link>
                                    </li>
                                </ul>
                            </div>
                            <div class="menu_section">
                                <h3>数据管理</h3>
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-laptop"></i> 商品管理 <span
                                            class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li>
                                                <router-link to="/main/plist">商品列表</router-link>
                                            </li>
                                            <li>
                                                <router-link to="/main/psearch">多条件搜索</router-link>
                                            </li>
                                            <li>
                                                <router-link to="/main/padd">添加商品</router-link>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a><i class="fa fa-user"></i> 用户管理 <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li>
                                                <router-link to="/main/ulist">用户列表</router-link>
                                            </li>
                                            <li>
                                                <router-link to="/main/usearch">用户检索</router-link>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a><i class="fa fa-shopping-cart"></i> 订单管理 <span
                                            class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                            ...
                            <div class="menu_section">
                                <h3>内容管理</h3>
                                <ul class="nav side-menu">
                                    <li><a><i class="fa fa-life-ring"></i> 首页商品管理 <span
                                            class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                    ...
                                    <li><a><i class="fa fa-windows"></i> 功能页面 <span
                                            class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li role="presentation" class="dropdown">
                                    ...
                                    <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                                        <li>
                                            <a>
                                                <span class="image"><img src="../assets/img/user.png"
...
<script>
    //此处只能引入通用js文件，不涉及任何具体DOM树操作
    import '../assets/js/jquery.js'
    import '../assets/js/jquery.flot.js'
    import '../assets/js/bootstrap.js'
    // import '../assets/js/app.js'
    //此处不能引入任何具体DOM元素查找的js文件
